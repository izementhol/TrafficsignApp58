...
public class MainActivity extends AppCompatActivity {
    //Explicit
    ListView listView;
    private int[] ints = new int[] {R.drawable.traffic_01,R.drawable.traffic_02,R.drawable.traffic_03,R.drawable.traffic_04,R.drawable.traffic_04,R.drawable.traffic_05,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //เอาค่า XML ที่ File my_content มาเเสดงผล
